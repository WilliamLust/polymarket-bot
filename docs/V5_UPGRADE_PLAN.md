...
### 1. Kill Profit-Lock Exit [DONE] -> Hold to Resolution
...
### 2. Skip Markets Closing <8h [DONE] (3 lines)
...
### 3. Spatial Correlation Caps [DONE] -- Weather Regions (30 min)
...
### 4. Multi-Model Convergence Gate [DONE] (2-3 hr, kl_weather.js)
...
### 5. Cron-Triggered Weather Scan [DONE] (1 hr)
...
### 6. Verify Kelly Fraction [CONFIRMED - no change] (5 min, no code change)
